    ...
    public function up(): void
    {
        ...
        (
            ...
            SELECT 
                ...
                ,p3.location AS opp_prev_location
                ,p3.opponent AS opp_prev_opponent
                ,p3.team_moneyline AS opp_prev_team_moneyline
                ,p3.opponent_moneyline AS opp_prev_opponent_moneyline
                ,p3.spread_line AS opp_prev_spread_line
                ,p3.result AS opp_prev_result
                ,p3.total_line AS opp_prev_total_line
                ,p3.total AS opp_prev_total
            FROM _pivot p
            LEFT JOIN _pivot p2 ON 
                p2.team = p.team
                AND p2.season = p.season
                AND p2.week = p.week - 1
            LEFT JOIN _pivot p3 ON
            	   p3.team = p.opponent
            	   AND p3.season = p.season
                AND p3.week = p.week - 1
            ORDER BY
                season DESC
                ,week DESC
                ,gametime DESC
